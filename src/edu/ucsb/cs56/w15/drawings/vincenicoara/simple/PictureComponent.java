package edu.ucsb.cs56.w15.drawings.vincenicoara.simple;
...
/**
   ...
   @author Vince Nicoara (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Rectangle house = new Rectangle(50, 200, 200, 100);
      Rectangle door = new Rectangle(125, 250, 35, 50); 
      g2.draw( house);
      g2.draw( door);

       // lroof and rroof are the left and right sides of the roof,
       Line2D.Double lroof = new Line2D.Double(50, 200, 150, 150);
       Line2D.Double rroof = new Line2D.Double(150,150, 250,200);
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Vince Nicoara", 20,40);
    }
